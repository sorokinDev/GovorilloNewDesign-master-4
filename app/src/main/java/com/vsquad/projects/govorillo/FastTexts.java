...
public class FastTexts extends AppCompatActivity
    ...
    ArrayList<String> FastTexts = new ArrayList<String>();
    ...
    private TextView titletextfast;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        setContentView(R.layout.activity_fast_texts);
        ...
        titletextfast = (TextView) findViewById(R.id.tv10);


        /// HERE PARSING

        randomnum = (int) Math.ceil(Math.random() * FastTexts.size()) - 1;


        //////////////

        //new JSONTask().execute("http://govorilloserver.azurewebsites.net/Neurwarexploded/");

        ///////////////
        titletextfast.setText(FastTexts.get(randomnum));
    ...
    private Vocalizer voc;
    public void doit(View view){
        //System.out.println("Telling");
        Vocalizer.createVocalizer(Vocalizer.Language.RUSSIAN,FastTexts.get(randomnum), true, Vocalizer.Voice.JANE).start();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.fast_texts, menu);
        return true;
    }
