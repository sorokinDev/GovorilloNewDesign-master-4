...
public class RandomText extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subtitle = (TextView) findViewById(R.id.mytitle);
        MainBtn = (ImageView) findViewById(R.id.MainBtn);

        Intent intent = getIntent();
        xp = intent.getIntExtra("xp", xp);

        String[] titles = {"Животные", "Детство", "Отношения"};
        String[] textstotitles = {
                "• Какое животное олицетворяет тебя? Почему?\n" +
                        "• Почему люди заводят домашних питомцев?\n" +
                        "• Твои рассуждения о теории Дарвина\n" +
                        "• Есть ли у животных сознание? Приведи 3 аргумента\n" +
                        "• Расскажи миф, легенду или сказку о животных\n",
                "• Расскажи самый лучший момент из твоего детства\n" +
                        "• Как ты думаешь, чье детство лучше: ваше или нынешнего поколения?\n" +
                        "• Кто, помимо родителей, в наибольшей степени повлиял на твое формирование личности?\n" +
                        "• Твои детские хобби и доп. занятия\n" +
                        "• Опиши себя в детстве\n",
                "• Опиши свой идеал отношений\n" +
                        "• Верите ли вы в любовь с первого взгляда? Почему?\n" +
                        "• Что вы думаете о сайтах знакомств? Пользовались ли вы их сервисом?\n" +
                        "• Кто должен платить за ужин на первом свидании? Почему?\n" +
                        "• Как вы переживаете расставания? \n"
        };

        int randomnum = (int) Math.ceil(Math.random() * 3) - 1;
        System.out.println("Рандом число: " + (randomnum));

        subtitle.setText(titles[randomnum]);
        title.setText(textstotitles[randomnum]);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.random_text, menu);
        return true;
    }
